...
[Jean Machuca](https://github.com/jeanmachuca) that turn a single `INIT` into a complete,
deliverable product — from web apps to end-to-end hardware/software blueprints — emitted as
structured output.
